        ...
        {auth ?
          <>
            ...
            <div className={styles.menuContainer}>
              ...
              <button className={styles.btnSecondary} onClick={() => clearToken()}>LOGOUT</button> {/* todo */}
            </div>
          </>
          :
          <>
            <div className={styles.menuContainer}>
              ...
              <button className={styles.btnSecondary} onClick={() => persistToken('mock_access_token')}>LOGIN</button> {/* todo */}
            </div>
          </>
        }
      </div>
